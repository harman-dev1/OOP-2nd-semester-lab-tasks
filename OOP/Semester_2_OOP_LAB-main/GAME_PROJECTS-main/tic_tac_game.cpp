...
main()
{
    ...
    while(true)
    {
        for(int i=0;i<gridSize*gridSize;i++)
        {
            ...
            cout<<"enter row number from 0 to 2:"<<endl;
            cin>>num1;
            if(num1 > 2)
            {
                continue;
            }
            cout<<"enter coulomn number from 0 to 2:"<<endl;
            cin>>num2;
            if(num2>2)
            {
                continue;
            ...
            if(board[num1][num2] == ' ')
            {
                ...
                { 
                    ...
                    bool result1=checkRows('*');
                    bool result2=checkColumns('*');
                ...
                else 
                {
                    ...
                    bool result1=checkRows('0');
                    bool result2=checkColumns('0');
                    if(result == 1 || result1 == 1 || result2 == 1)
                    {
